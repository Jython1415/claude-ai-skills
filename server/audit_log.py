...
class AuditLog:
    ...
    def proxy_request(self, session_id: str, service: str, method: str,
                      path: str, upstream_url: str, status_code: int) -> None:
        self._write({
            "event": "proxy_request",
            "session_id": session_id,
            "service": service,
    ...
    def git_fetch(self, session_id: Optional[str], repo_url: str, status_code: int) -> None:
        self._write({
            "event": "git_fetch",
            "session_id": session_id,
            "repo_url": repo_url,
    ...
    def git_push(self, session_id: Optional[str], repo_url: str, branch: str,
                 status_code: int, pr_url: Optional[str] = None) -> None:
        self._write({
            "event": "git_push",
            "session_id": session_id,
            "repo_url": repo_url,
